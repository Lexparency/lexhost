...
_filters = {
    "de": StopStem(
        token_filter("german_stop", type="stop", stopwords="_german_"),
        token_filter("german_stemmer", type="stemmer", language="light_german"),
    ),
    "es": StopStem(
        token_filter("spanish_stop", type="stop", stopwords="_spanish_"),
        token_filter("spanish_stemmer", type="stemmer", language="light_spanish"),
    ),
    "en": StopStem(
        token_filter("english_stop", type="stop", stopwords="_english_"), "porter_stem"
    ),
}
...
def create_analysis(language) -> analyzer:
    ...
    return analyzer(
        ...
        tokenizer="standard",
        filter=["lowercase", "asciifolding", f.stop, f.stem],
    )
