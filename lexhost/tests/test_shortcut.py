...
class TestShortCut(unittest.TestCase):
    ...
    def test_dead_simple_short_cut(self):
        for ordinate in ('Verordnung 575/2013', 'Verordnung (EU) 575/2013',
                         'Verordnung No. 575/2013', 'Verordnung 575/2013/EU',
        ...
        self.assertEqual(
            i2p({'32013R0077', '31977R2013', '32013L0077', '31977L2013',
                 '32013D0077', '31977D2013', '32013F0077', '31977F2013'}),
            set(DeadSimpleShortCut('Verordnung 77/2013').paths)
        )
        self.assertEqual(
            i2p({'31983R0077', '31977R0083', '31983L0077', '31977L0083',
                 '31983D0077', '31977D0083', '31983F0077', '31977F0083'}),
        ...
        self.assertEqual(
            set(),
            set(DeadSimpleShortCut('Wie bitte?').paths)
        )

    def test_short_cutter(self):
        # case: Reference is directly parseable by the reflector
        self.assertEqual(
            [TitledLocation(href='/eu/32013R0575/',
                            title='Regulation (EU) 575/2013')],
        ...
        self.assertEqual(
            [],
            ShortCutter('Regulation (EU) 575/2013',
                        document_context='/eu/32013R0575/').hits
        )
